...
def weather(location):
    ...
    url = 'https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query='+ Finallocation
    ...
    if 'None' in str(ErrorCheck):
        ...
        weather_list.append(LocationInfo)
        weather_list.append(NowTemp) 
        weather_list.append(TodayFeelTemp) 
        weather_list.append(TodayMorningTemp) 
        weather_list.append(TodayAfternoonTemp) 
        weather_list.append(WeatherCast) 
        weather_list.append(TodayUV) 
        weather_list.append(FineDust) 
        weather_list.append(UltraFineDust) 
        weather_list.append(Ozon) 
        weather_list.append(tomorrowMoring) 
        weather_list.append(tomorrowMState) 
        weather_list.append(tomorrowAfter) 
        weather_list.append(tomorrowAState)  
        #await tt.send('Hello')
        return weather_list